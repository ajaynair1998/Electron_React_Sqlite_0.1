  ...
  constructor() {
    ...
    this.state = {
      data: {
        ...
        Blood_Group: "Not Selected",
        Doctor_Name: "Dr Arun Babu",
        ...
        return (
          <div id="Image_and_Button" className="data_field">
            ...
            <button
              ...
              onClick={this.handleClickCaptureImage}
            >
              Capture
            </button>
          </div>
      ...
      <div id="Register">
        ...
        <div id="contents">
          <form class="signup-form" action="/register" method="post">
            ...
            <div id="Picture_Container">{ImageFieldRender()}</div>
            ...
            <div class="form-container">
              <div class="form-body">
                ...
                <div className="data_field">
                  ...
                  <input
                    id="Patient_id"
                    placeholder="Id will be autogenerated"
                    type="text"
                    onChange={this.handleChange}
                  ></input>
                </div>
