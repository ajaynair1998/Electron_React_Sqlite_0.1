...
class ProfilePage extends Component {
  ...
  handleClickSubmit(event) {
    if (event.target.id === "save_button") {
      window.ipcRenderer.send("Edited-Profile-Data-From-React", [
        Patient_id,
        this.state.data,
      ]);
    }
  ...
  render() {
    ...
    let mainSectionRender = () => {
      if (this.state.loaded) {
        ...
        // if in viewMode
        if (this.state.mode === "viewMode") {
          return <ViewMode data={stateDataOnMount} />;
        }
        // if in edit mode
        else if (this.state.mode === "editMode") {
          return (
        ...
        // if in delete mode
          ...
          return <DeleteMode handleClickDelete={this.handleClickDelete} />;
        }
      }
    };
