...
class ViewPage extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      data: {
        ...
        Patient_Name: null,
        Chief_Complaint:
          "[[2,'27-07-1992','lorem','ipsum'],[1,'27-07-1992','bad','man']]",
        Past_Medical_History: null,
        Past_Dental_History: null,
        Drug_Allergy: null,
        General_Examination:
          "[[2,'27-98-9876','120/80','80F','20%'],[1,'27-98-9876','130/80','90F','30%']]",
        Local_Examination:
          "[[1,'25-34-9876','extraoral something','intra oral something']]",
    ...
    this.handleClickGeneralExamination =
      this.handleClickGeneralExamination.bind(this);
    this.handleClickLocalExamination =
      this.handleClickLocalExamination.bind(this);
    this.handleClickClinicalDiagnosis =
      this.handleClickClinicalDiagnosis.bind(this);
  ...
  handleClickSaveAllButton(event) {
    ...
    window.ipcRenderer.send("Edit-Profile-View-Page", [
      patientId,
      this.state.data,
    ]);
  }
  ...
  handleClickChiefComplaint(event) {
    ...
    if (event.target.id === "add_button_chief_Complaint") {
      ...
      if (this.state.data.Chief_Complaint === null) {
        ...
        // taking the entry
        entryone = JSON.stringify([
          [1, date, chiefComplaint, historyOfComplaint],
        ]);
      ...
      // if there are chief complaints in there
        ...
        let maxOfOldEntries = Math.max(...oldEntries.map((item) => item[0]), 0);

        entry = [
          parseInt(maxOfOldEntries + 1),
          date,
          chiefComplaint,
          historyOfComplaint,
        ];
  ...
  handleClickGeneralExamination(event) {
    ...
    if (event.target.id === "general_examination_add_button") {
      ...
      if (this.state.data.General_Examination === null) {
        let data = this.state.data;
        data.General_Examination = JSON.stringify([
          [1, todaysDate, bp, temperature, oxygensaturation],
        ]);
      ...
      // if the state is non empty we have to add the entry to the first position
        ...
        let maxOfOldEntries = Math.max(...entries.map((item) => item[0]), 0);
  ...
  handleClickTreatmentPlan(event) {
    ...
    if (event.target.id === "add_button_treatment_plan") {
      ...
      if (this.state.data.Treatment_Plan === null) {
        ...
        let currentEntry = [
          [1, todaysDate, treatmentPlanValue, treatmentValue],
        ];
  ...
  handleClickMedicine(event) {
    ...
    if (event.target.id === "add_button_medicine") {
      ...
      if (this.state.data.Medicines === null) {
        ...
        let currentEntry = [
          [1, todaysDate, medicineTypeValue, medicineValue, frequencyValue],
        ];
  ...
  handleClickFollowUp(event) {
    ...
    if (event.target.id === "add_button_follow_up") {
      ...
      if (this.state.data.Follow_Up === null) {
        ...
        let currentEntry = [
          [1, todaysDate, followUpTextValue, followUpDateValue],
        ];
  ...
  handleClickInvestigation(event) {
    ...
    if (event.target.id === "add_button_investigation") {
      ...
      if (this.state.data.Investigation === null) {
        ...
        let investigationValue =
          investigation_file_element.current.files[0].path;

        let data = this.state.data;

        let currentEntry = [
          [1, todaysDate, investigationTypeValue, investigationValue],
        ];
            ...
            <div className="input_entry">
              ...
              <div className="input_rows">
                <input
                  ...
                  ref={this.chief_complaint_input}
                ></input>
                <input
                  placeholder="History of This Complaint"
                  id="history_of_complaint_input"
                  ref={this.complaint_history_input}
                ></input>
              </div>

              <div className="add_button">
                <button
                  id="add_button_chief_Complaint"
                  onClick={this.handleClickChiefComplaint}
                >
                  Add
                </button>
              </div>
          ...
          return (complaints = complaints.map((item) => {
            return (
              <ChiefComplaint
                ...
                index={item[0]}
                date={item[1]}
                chiefComplaint={item[2]}
                historyOfComplaint={item[3]}
                handleClickChiefComplaint={this.handleClickChiefComplaint}
              />
            );
          }));
        };
          ...
          <div className="dataarea">
            <div className="input_entry">
              ...
              <div className="input_rows">
                <input
                  placeholder="Complaint"
                  className="chief_complaint"
                  ref={this.chief_complaint_input}
                ></input>
                <input
                  placeholder="History of This Complaint"
                  className="history_of_complaint"
                  ref={this.complaint_history_input}
                ></input>
              </div>
        ...
        return (
          <div className="dataarea">
            <div className="single_input">
              <div>
                <input id="bp" placeholder="BP" ref={this.bp_input}></input>
              </div>
              <div>
                <input
                  id="temperature"
                  placeholder="Temperature"
                  ref={this.temperature_input}
                ></input>
              </div>
              <div>
                <input
                  id="o2_saturation"
                  placeholder="O2"
                  ref={this.oxygensaturation_input}
                ></input>
              </div>
              <div>
                <button
                  id="general_examination_add_button"
                  onClick={this.handleClickGeneralExamination}
                >
                  Add
                </button>
              </div>
          ...
          return generalExamination.map((item) => {
            return (
              <GeneralExamination
                ...
                bp={item[2]}
                temperature={item[3]}
                oxygensaturation={item[4]}
                handleClickGeneralExamination={
                  this.handleClickGeneralExamination
                }
              />
            );
        ...
        return (
          <div className="dataarea">
            <div className="input_entry">
              ...
              <div className="input_rows">
                <input
                  placeholder="Extra Oral"
                  className="input_extraoral"
                  ref={this.extra_oral_input}
                ></input>
                <input
                  placeholder="Intra Oral"
                  className="input_intraoral"
                  ref={this.intra_oral_input}
                ></input>
              </div>

              <div className="add_button">
                <button
                  id="add_button_local_examination"
                  onClick={this.handleClickLocalExamination}
                >
                  Add
                </button>
              </div>
        ...
        return (
          <div className="dataarea">
            <div className="input_entry">
              ...
              <div className="input_rows">
                <input
                  placeholder="Add Clinical Diagnosis"
                  ref={this.clinical_diagnosis_input}
                ></input>
              </div>
              {/* <div className='date'>
                                <p>{todaysDate}</p>
              ...
              <div className="add_button">
                <button
                  id="add_button_clinical_diagnosis"
                  onClick={this.handleClickClinicalDiagnosis}
                >
                  Add
                </button>
              </div>
        ...
        return (
          <div className="dataarea">
            <div className="input_entry">
              ...
              <div className="add_button">
                <button
                  id="add_button_diagnosis"
                  onClick={this.handleClickDiagnosis}
                >
                  Add
                </button>
              </div>
            ...
            <div className="input_entry">
              ...
              <div className="input_rows">
                <input
                  ...
                  className="input_treatment_plan"
                  ref={this.treatment_plan_input}
                ></input>
                <input
                  placeholder="Treatment"
                  className="input_treatment"
                  ref={this.treatment_input}
                ></input>
              </div>
              {/* <div className='date'>
                            <p>xx/xx/xxxx</p>
              ...
              <div className="add_button">
                <button
                  id="add_button_treatment_plan"
                  onClick={this.handleClickTreatmentPlan}
                >
                  Add
                </button>
              </div>
          ...
          return (treatmentplans = treatmentplans.map((item) => {
            return (
              <TreatmentPlan
                ...
                index={item[0]}
                date={item[1]}
                treatmentplan={item[2]}
                treatment={item[3]}
                handleClickTreatmentPlan={this.handleClickTreatmentPlan}
              />
            );
          }));
        };
            ...
            <div className="input_entry">
              ...
              <div className="input_rows">
                <input
                  ...
                  id="medicine_name"
                  ref={this.medicine_input}
                ></input>
              </div>
              <div className="frequency">
                <input
                  placeholder="Enter the frequency Here"
                  ref={this.frequency_input}
                ></input>
              </div>
              {/* <div className='date'>
                                <p>xx/xx/xxxx</p>
              ...
              <div className="add_button">
                <button
                  id="add_button_medicine"
                  onClick={this.handleClickMedicine}
                >
                  Add
                </button>
              </div>
          ...
          return (medicine = medicine.map((item) => {
            return (
              <Medicine
                ...
                medicinetype={item[2]}
                medicine={item[3]}
                handleClickMedicine={this.handleClickMedicine}
                frequency={item[4]}
              />
            );
          }));
            ...
            <div className="input_entry">
              ...
              <div className="input_rows">
                <input
                  ...
                  className="follow_up_input_text"
                  ref={this.follow_up_text_input}
                ></input>
                <input
                  type="date"
                  placeholder="Add Diagnosis"
                  className="follow_up_input_date"
                  ref={this.follow_up_date_input}
                ></input>
              </div>

              <div className="add_button">
                <button
                  id="add_button_follow_up"
                  onClick={this.handleClickFollowUp}
                >
                  Add
                </button>
              </div>
          ...
          return (followups = followups.map((item) => {
            return (
              <FollowUp
                ...
                followuptext={item[2]}
                followupdate={item[3]}
                handleClickFollowUp={this.handleClickFollowUp}
              />
            );
          }));
        };
            ...
            <div className="input_entry">
              ...
              <div className="input_rows">
                ...
                <input
                  id="select_file"
                  type="file"
                  ref={this.investigation_file_input}
                ></input>
              </div>

              <div className="add_button">
                <button
                  id="add_button_investigation"
                  onClick={this.handleClickInvestigation}
                >
                  Add
                </button>
              </div>
    ...
    return (
      <div id="view">
        <div id="navbar">
          ...
          <div id="contents">
            <div id="controls">
              <h2 onClick={this.handleClickGoTo} id="GoToButton">
                {" "}
                Go To{" "}
              </h2>

              <h2 id="save_button" onClick={this.handleClickSaveAllButton}>
                Save
              </h2>
            </div>
            <div id="main">
              ...
              <div id="past_medical_history">
                ...
                <div className="dataarea">
                  <textarea
                    ...
                    placeholder="No Past medical History Yet"
                    onChange={this.handleChangeTextAreas}
                    defaultValue={
                      this.state.data.Past_Medical_History
                        ? this.state.data.Past_Medical_History
                        : ""
                    }
                  ></textarea>
              ...
              <div id="past_dental_history">
                ...
                <div className="dataarea">
                  <textarea
                    ...
                    placeholder="No Past Dental History"
                    onChange={this.handleChangeTextAreas}
                    defaultValue={
                      this.state.data.Past_Dental_History
                        ? this.state.data.Past_Dental_History
                        : ""
                    }
                  ></textarea>
              ...
              <div id="drug_allergy">
                ...
                <div className="dataarea">
                  ...
                  <div className="drug_allergy_input">
                    <textarea
                      id="Drug_Allergy"
                      placeholder="No Drug Allergies Found Yet"
                      onChange={this.handleChangeTextAreas}
                      defaultValue={
                        this.state.data.Drug_Allergy
                          ? this.state.data.Drug_Allergy
                          : ""
                      }
                    ></textarea>
